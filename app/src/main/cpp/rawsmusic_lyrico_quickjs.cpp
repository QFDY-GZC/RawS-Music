...
Java_com_rawsmusic_lyrico_runtime_QuickJsNative_createRuntime(
        JNIEnv *env,
        jobject,
...
Java_com_rawsmusic_lyrico_runtime_QuickJsNative_eval(
        JNIEnv *env,
        jobject,
        jlong runtimePtr,
        jstring script,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_rawsmusic_lyrico_runtime_QuickJsNative_call(
        JNIEnv *env,
        jobject,
        jlong runtimePtr,
...
Java_com_rawsmusic_lyrico_runtime_QuickJsNative_closeRuntime(
        JNIEnv *,
        jobject,
        jlong runtimePtr) {
    if (runtimePtr == 0) {
