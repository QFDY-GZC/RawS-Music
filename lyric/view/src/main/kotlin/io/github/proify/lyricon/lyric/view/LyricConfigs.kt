...
interface SyllableConfig {
    ...
    var enableCharFloatAnimation: Boolean
    var enableSharpen: Boolean
    var sharpenIntensity: Float
}
...
data class DefaultSyllableConfig(
    ...
    override var enableCharFloatAnimation: Boolean = true,
    override var enableSharpen: Boolean = false,
    override var sharpenIntensity: Float = 1.0f,
) : SyllableConfig {
    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (javaClass != other?.javaClass) return false
        ...
        if (enableCharFloatAnimation != other.enableCharFloatAnimation) return false
        if (enableSharpen != other.enableSharpen) return false
        if (sharpenIntensity != other.sharpenIntensity) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + enableCharFloatAnimation.hashCode()
        result = 31 * result + enableSharpen.hashCode()
        result = 31 * result + sharpenIntensity.hashCode()
        return result
    }
}
