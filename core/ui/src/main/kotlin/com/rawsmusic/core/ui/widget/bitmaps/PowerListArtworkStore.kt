 ...
 *
 * The design keeps a P wrapper per artwork type/id and the view only binds that wrapper.  This store gives
...
object PowerListArtworkRecords {
    ...
    private class ArtworkRecord(private val id: FileArtworkId) {
        ...
        fun publish(handle: ArtworkHandle, targetWidth: Int, targetHeight: Int, forceHigh: Boolean) {
            ...
            // The P wrapper classifies low/high from the wrapper that actually exists,
